   ...
   ?>
    <div class="col-md-12">
     ...
     <h3 align="center">แก้ไขวัสดุสิ้นเปลือง</h3><br />
      ...
      {
  ?>
       <form action="edit_material_SQL_user.php?img=<?php echo $row["img"];?>" method="POST" enctype="multipart/form-data"> 
  <label>ชื่อประเภท</label>
    ...
    <br>
     <button class="btn btn-success" type="submit" value="submit" id="submit" name="submit">บันทึก</button>
      <button class="btn btn-danger" type="button" ><a href="delete_material_user.php?code=<?php echo $row["code"];?>">ลบ</a></button>
