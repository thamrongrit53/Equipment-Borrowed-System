...
$result = mysqli_query($condb,$query);
   ...
   ?>
        <form action="return_tool_SQL_manager.php" method="POST">
            <label>วันรับคืน</label>
            <input type="date" name="date_r" class="form-control">
            <label>ชื่อผู้รับคืน</label>
            <input type="text" name="name_r" class="form-control" value="<?php echo $_SESSION['name_u'];?>">
