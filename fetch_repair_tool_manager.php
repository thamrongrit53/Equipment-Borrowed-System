...
{ 
 ...
 $query = "
  SELECT * FROM tb_tool WHERE code LIKE '%".$search."%'";
}
else
{
  ...
  $output .= '
   <tr>
    ...
    <td><a target="_blank" href="img_tool/'.$row["img"].'"><img src="img_tool/'.$row["img"].'" style="width: 100px;height: 150px;"></td>
     <td><button type="button" class="btn btn-primary"><a href="notify_repair_tool_num_manager.php?code='.$row["code"].'">แจ้งซ่อม</a>
     </button>
     </td>
   </tr>
  ';
